...
class Matrix(object):
    ...
    def inverse(self):
        ...
        if self.h > 2:
            ...
            det = a * d - b * c
            if det == 0:
                raise ValueError('The matrix can not be inverted')
            else:
                inverse.g[0][0] =  d/det
                inverse.g[0][1] = -b/det
                inverse.g[1][0] = -c/det
    ...
    def __add__(self,other):
        ...
        for r in range(self.h):
            for c in range(self.w):
                result.g[r][c] = self.g[r][c] + other.g[r][c]
        return result
